...
var exampleData = 'https://knb.ecoinformatics.org/knb/d1/mn/v2/object/';
var exampleObj = '/object';

var examplePID = '010172ce-2068-48a8-9aa1-071c8c8accc6-snotel_201702_1034.xml';

// PID
var waterRes = exampleData + '08d9af19-9800-4a2d-8032-81adff1a2a4f-PRISM-T-mean-celcius-Quay.xml';

var dataTable = document.getElementById('xmlDataTable');

var dataOne = new Request(exampleData);
console.log('\'byte ' + dataOne.url);

var waterRequest = new Request(waterRes);
console.log(waterRequest.url);
var waterRequestTable = document.getElementById('waterRequestTable');
  ...
  $.ajax({
    ...
    success: function populateTable(xml, status) {
      $(xml).find('descript').each(function () {
        ...
        // supplinf
        var supplinf = $(this).find('supplinf').text();
      ...
      $(xml).find('spdoinfo').each(function () {
        // abstract
        var indspref = $(this).find('indspref').text();
      ...
      $(xml).find('eainfo').each(function () {
        ...
        // eainfo
        var rdommin = $(this).find('rdommin').text();
        // rdomain.makeArray(rdomminArr);
        var rdommax = $(this).find('rdommax').text();
        var attrunit = $(this).find('attrunit').text();
  ...
  $.ajax({
    ...
    success: function success(xml) {
      $(xml).find('objectInfo').each(function () {
        ...
        var fId = $(this).find('formatId').text();
        // console.log(`fId ${fId}`);

        var metaData = $(this).find('dateSysMetadataModified').text();
